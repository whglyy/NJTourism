...
- (void)drawRect:(CGRect)rect
{
    ...
    if (__hasLogo) {
        ...
        logoView.frame = CGRectMake((bgImView.width - 35)/2, 15, 35, 35);
        [bgImView addSubview:logoView];
    }
    //background image view
    if (__hasLogo) {
        self.label.frame = CGRectMake(10, logoView.bottom+10, bgImView.width - 20, labelHeight);
    }else{
        self.label.frame = CGRectMake(10,0, bgImView.width - 20, labelHeight);
    }
