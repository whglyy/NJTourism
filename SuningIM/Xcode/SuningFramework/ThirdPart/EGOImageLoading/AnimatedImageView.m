...
- (void)setImageFileData:(NSData *)imageFileData
{
    ...
    if (imageFileData != _imageFileData) 
    {
       
        
        _imageFileData = imageFileData ;
        
        if (![AnimatedImageView isGifImage:_imageFileData]) 
        {
...
- (void)GIFReadExtensions
{
	...
	unsigned char cur[1]={0x00}, prev[1]={0x00};
    [self GIFGetBytes:1];
...
- (void)GIFReadDescriptor
{
    ...
    [NSMutableData dataWithData:[@"GIF89a" dataUsingEncoding: NSUTF8StringEncoding]];
