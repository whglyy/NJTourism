...
@interface ImageViewTextField : UITextField
{
    ...
    BOOL          _isSelected;
    //代理
    id <ImageViewTextFieldDelegate>  __weak _imageViewTextFieldDelegate;
    //用于存放绘图后返回的结果
...
//用于展示多张照片的视图
@property (nonatomic,retain)  UIView *showImageList;
//照相机按钮、分享按钮及说明性文字
@property (nonatomic,retain) UIView *takePhotoAndShare;
//图片上悬浮的关闭按钮
@property (nonatomic,retain) UIButton *closeBtn;
//存放照片视图和按钮视图
@property (nonatomic,retain) UIView *imageAndButtonView;
//照片组合后的视图
@property (nonatomic,retain) UIImageView *imageConbineView;
//代理
